...
AntBot에서 사용하는 토픽 및 서비스 명세입니다. 센서 배치 및 좌표 정보는 [주요 센서 사양](/antbot/hardware/sensor-coordinates/)을 참조하세요.
...
:::note
RGB-D 카메라는 별도 SDK를 통해 별도 토픽으로 퍼블리시됩니다.
:::
...
| `/hw/direct_read` | `antbot_interfaces/DirectRead` | [컨트롤 아이템](/antbot/development-guide/control-table/) 읽기 |
| `/hw/direct_write` | `antbot_interfaces/DirectWrite` | [컨트롤 아이템](/antbot/development-guide/control-table/) 쓰기 |
