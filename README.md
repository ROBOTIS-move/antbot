...
| [`antbot_camera`](antbot_camera/) | Multi-driver camera package (V4L2 / USB / RGB-D) |
...
<table>
  ...
  <tr>
    ...
    <td>1× Stereo RGB-D + 4× Mono (V4L2)</td>
  </tr>
  <tr>
    <td><strong>3D LiDAR</strong></td>
    <td>3D LiDAR (Ethernet)</td>
  </tr>
  <tr>
    <td><strong>2D LiDAR</strong></td>
    <td>2× 2D LiDAR (USB Serial)</td>
  </tr>
  <tr>
...
| `/imu/accel_gyro` | [![sensor_msgs](https://img.shields.io/badge/sensor__msgs-Imu-0d6efd?style=flat-square)](https://docs.ros2.org/latest/api/sensor_msgs/msg/Imu.html) | IMU data (quaternion, angular velocity, linear acceleration) |
