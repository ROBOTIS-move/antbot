...
- **Multi-camera driver** — V4L2, USB, RGB-D 카메라 동시 지원
...
| `/imu/accel_gyro` | [![sensor_msgs](https://img.shields.io/badge/sensor__msgs-Imu-0d6efd?style=flat-square)](https://docs.ros2.org/latest/api/sensor_msgs/msg/Imu.html) | IMU 데이터 (쿼터니언, 각속도, 선가속도) |
